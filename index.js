...
client.on('message', message => {
    ...
    Virdina.createCommand('sayang', function(msg, res) {
        pesan = ``
        pesan += `* Apa Sayanggg 😳 *\n*Menu*\n\n💡Brainly Search\n/brainly <pertanyaan> -<jumlah>\n*/brainly rumus mtk -10*`
        pesan += `\n\n\n💡Kalkulator\n_hanya bisa kali(*) bagi(/) tambah(+) kurang(-)_\n/math <angka>\n*/math 100+70/2*`
        pesan += "\n\n*Follow Ig Tuanku @inigozal*"
        Virdina.replyMessage(pesan)
    })
})

     Virdina.createCommand('beb', function(msg, res) {
        pesan = ``
        pesan += ` Hai Juga Beb 😗\n Kenalin aku adalah Bot yang dibuat untuk bantu kamu Nugasss \n`
        pesan += ` Nih cara panggi akuu \n */sayang* \n */beb* `
        pesan += "\n\n*Inget Yaa* , jgn berlebihan pakenya \n Aku juga perlu istirahat 🥺"
        Virdina.replyMessage(pesan)
    })
})
